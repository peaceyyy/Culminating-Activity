...
```{r cart-tree-visual, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.width=7.5, fig.height=4.8, out.width='0.95\\linewidth', fig.pos="H", fig.cap="CART Tree for Job Satisfaction (Seed 200, Corrected Baseline)"}
library(rpart)
library(rpart.plot)
...
```{r cp-profile-visual, echo=FALSE, fig.width=7, fig.height=4, fig.pos="H", fig.align='center', out.width='0.95\\linewidth', fig.cap="Cross-Validated Error by Complexity Parameter (CP)", message=FALSE, warning=FALSE}
library(ggplot2)
...
```{r hyperparam-shuffling-visual, echo=FALSE, fig.width=7.5, fig.height=4.5, fig.pos="H", fig.align='center', out.width='0.95\\linewidth', fig.cap="Cross-Validated Error by CP Across Hyperparameter Combinations", message=FALSE, warning=FALSE}
library(ggplot2)
...
```{r seed-sensitivity-visual, echo=FALSE, fig.width=7, fig.height=4.2, fig.pos="H", fig.align='center', out.width='0.95\\linewidth', fig.cap="Variable Importance Stability Across Different Imputation Seeds", message=FALSE, warning=FALSE}
