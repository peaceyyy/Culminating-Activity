...
cat("Running MICE imputation (RF for numeric columns)...\n")
...
methods[] <- ""
methods["Salary"] <- "rf"
methods["Years_Exp"] <- "rf"
methods["Job_Satisfaction"] <- "rf"
...
write_csv(df_clean, "outputs/data_imputed_rf.csv")
cat("Exported to outputs/data_imputed_rf.csv\n")
